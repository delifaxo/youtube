      ...
      return (
        <div>
          ...
          <div>
           ...
           <button className="btn card bg-light btnleft"  onClick={OnPrevVideo}>Prev video</button>   
            <button className="btn card bg-light btnrigth" onClick={OnNextVideo}>Next video</button>
          </div>
        </div>
      )
    }
